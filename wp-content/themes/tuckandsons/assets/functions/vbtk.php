...
function vbtk_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_enqueue_script( 'js-core', get_template_directory_uri() . '/build/js/bower.js' );
    wp_enqueue_script( 'js-site', get_template_directory_uri() . '/build/js/scripts.js' );

    wp_enqueue_style( 'site-styles', get_template_directory_uri() . '/build/css/style.css', array(), date( 'YmdH' ), 'all' );
  }
}
